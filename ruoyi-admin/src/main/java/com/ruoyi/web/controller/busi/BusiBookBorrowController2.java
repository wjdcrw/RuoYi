...
import com.ruoyi.busi.service.IBusiBookBorrowService2;
...
public class BusiBookBorrowController2 extends BaseController {
    private String prefix = "busi/bookborrow";
    @Autowired
    private IBusiBookBorrowService2 borrowService;
